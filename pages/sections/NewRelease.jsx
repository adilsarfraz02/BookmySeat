...
const NewRelease = () => {
  ...
  return (
    <div className="mx-12 my-6 max-sm:mx-5">
      <div className="flex max-sm:px-2 items-center justify-between mb-4">
        <h1 className="text-4xl max-sm:text-2xl dark:text-[#bbb] text-black font-bold border-l-8 border-orange-600">
          &nbsp; New Release
        </h1>
        <p className="text-orange-600 text-xl mt-3 max-sm:m-0 font-bold hover:text-orange-800 cursor-pointer">
          <Link href="/movies"> Show all</Link>
        </p>
      </div>
